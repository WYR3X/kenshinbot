...
if(message.author.id !== message.guild.owner.user.id) return message.reply('<:kenshin_carpi:726170425779814413> Bu Komutu Kullanabilmek İçin yeterli Yetkiye Sahip Değilsin!')

  if (!args[0]) {
message.channel.send("<a:uyari_ver:726172121935511603> Lütfen **k!emojikur bilgi** kullanınız.")
}
    ...
    message.channel.send(
      new Discord.RichEmbed()
        ...
        .addField(
          ...
          `<a:uyari_ver:726172121935511603> Emoji Kurulum Öncesi Mutlaka Bota Yönetici Yetkisi Veriniz.\nSunucunun Emoji Slotunun Boş Olduğundan Emin Olunuz.\nSonraki Aşama Için k!emojikur kurulum Yazınız.`
        )
    );
  }
    ...
    message.channel.send(
      new Discord.RichEmbed()
        ...
        .addField(
          ...
          `<a:uyari_ver:726172121935511603> Emoji Kurulum Öncesi Aşamalar Tamamlandı ise Komutu Giriniz;\n**k!emojikur başlat** `
        )
    );
  }
  ...
  if (args[0] == "başlat")
    message.channel.send(
      `<a:uyari_ver:726172121935511603> Kurulum Başlatılsın mı? \n**evet** olarak cevaplayınız...\n10 Saniye Sonra Iptal Edilir.`
    );
  message.channel
    ...
    .then(collected => {
      ...
      message.guild
        ...
        .then(tm => {
          message.channel.send("<:kenshin_tik:726170369379139675> Emoji oluşturuldu.");
        })
        .catch(error => {
  ...
  message.channel.send("<:kenshin_tik:726170369379139675> Emoji Kurma Tamamlandı!!")
  });
};
exports.conf = {
  enabled: true,
