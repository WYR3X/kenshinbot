...
const emoji7 = message.client.emojis.get('📞');
      let isEnabled;
      message.reply("<:kenshin_tik:726170369379139675> Canlı Destek Komutunu Kullandığınız İçin Teşekkürler. Birazdan Yetkili Ekibimiz sizinle ilgilenicektir.");
      let mesaj = args.slice(0).join(' ');
      let chan = message.channel;
      let destekKanal = "727867650901934111";
